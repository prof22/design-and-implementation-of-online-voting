<div class="form-group">
  ...
  <div class="col-md-4">
    <select name="exam" id="exam" class="form-control" required>
    	<option value="wassce private">Wassce Private</option>
...
<div class="form-group">
  <label class="control-label col-md-2">O'level</label>
  <div class="col-md-6">
...
<div class="form-group">
  <label class="control-label col-md-2">Jamb Registration Number</label>
  <div class="col-md-10">
...
<div class="form-group">
  <label class="control-label col-md-2">Jamb Result</label>
  <div class="col-md-6">
